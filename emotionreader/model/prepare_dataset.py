...
def detect_faces(emotion, face_detectors):
    ...
    for num, f in enumerate(files):
        ...
        faces = [det.detectMultiScale(gray, scaleFactor=1.1, minNeighbors=10, minSize=(5, 5), flags=cv2.CASCADE_SCALE_IMAGE)
        ...
        for (x, y, w, h) in facefeatures: #get coordinates and size of rectangle containing face
            ...
            try:
                ...
                cv2.imwrite("data/dataset/%s/%s.jpg" % (emotion, num), out) #Write image
